# Lab 8 solution: environments/dev/main.tf
# The VM admin password now comes from Azure Key Vault at apply time.
# There is no vm_admin_password variable any more.
