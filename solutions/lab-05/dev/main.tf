# Lab 5 solution, environments/dev/main.tf. Same configuration as Lab 4, moved
# into an environment directory, with the storage container renamed to
# orders_data via `terraform state mv`.
